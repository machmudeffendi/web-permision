    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-5 m-auto">
          <form action="priv/process-login.php" method="post">
            <div class="card mt-5">
              <div class="card-body text-center shadow">
                <label>LOGIN</label>
                <input type="text" name="username" class="form-control mb-1" placeholder="Username" required>
                <input type="password" name="password" class="form-control mb-3" placeholder="Password" required>
                <input type="submit" class="btn btn-warning btn-block shadow mb-1" value="Login">
                <a href="register.php" class="btn btn-register btn-block mb-2">Register</a>
              </div>
            </div>
          </form>
        </div>
